...
export class TraineeListViewComponent {
  ...
  protected readonly columns = computed((): DataGridColumn[] => [
    ...
    { key: 'speed', header: 'Spd', tooltip: 'Speed Bonus', width: '50px', type: 'statBonus', sortType: SortType.Number },
    { key: 'stamina', header: 'Stm', tooltip: 'Stamina Bonus', width: '50px', type: 'statBonus', sortType: SortType.Number },
    { key: 'power', header: 'Pwr', tooltip: 'Power Bonus', width: '50px', type: 'statBonus', sortType: SortType.Number },
    { key: 'guts', header: 'Gts', tooltip: 'Guts Bonus', width: '50px', type: 'statBonus', sortType: SortType.Number },
    { key: 'wits', header: 'Wts', tooltip: 'Wits Bonus', width: '50px', type: 'statBonus', sortType: SortType.Number },
    { key: 'turf', header: 'Turf', tooltip: 'Surface: Turf', width: '44px', type: 'aptitude', sortType: SortType.String },
    { key: 'dirt', header: 'Dirt', tooltip: 'Surface: Dirt', width: '44px', type: 'aptitude', sortType: SortType.String },
    { key: 'sprint', header: 'Spr', tooltip: 'Distance: Sprint', width: '44px', type: 'aptitude', sortType: SortType.String },
    { key: 'mile', header: 'Mile', tooltip: 'Distance: Mile', width: '44px', type: 'aptitude', sortType: SortType.String },
    { key: 'medium', header: 'Med', tooltip: 'Distance: Medium', width: '44px', type: 'aptitude', sortType: SortType.String },
    { key: 'long', header: 'Long', tooltip: 'Distance: Long', width: '44px', type: 'aptitude', sortType: SortType.String },
    { key: 'front', header: 'Frt', tooltip: 'Strategy: Front', width: '44px', type: 'aptitude', sortType: SortType.String },
    { key: 'pace', header: 'Pace', tooltip: 'Strategy: Pace', width: '44px', type: 'aptitude', sortType: SortType.String },
    { key: 'late', header: 'Late', tooltip: 'Strategy: Late', width: '44px', type: 'aptitude', sortType: SortType.String },
    { key: 'end', header: 'End', tooltip: 'Strategy: End', width: '44px', type: 'aptitude', sortType: SortType.String },
